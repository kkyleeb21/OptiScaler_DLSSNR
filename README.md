...
[中文说明](README_CN.md) · [Download 0.1.2](https://github.com/kkyleeb21/OptiScaler_DLSSNR/releases/tag/dlssnr-d18-v0.1.2) · [Installer guide](community/d18-installer/README.md)
...
The tables describe the **common 0.1.2 D18 UI**. Older and game-specific packages may expose different
...
1. Close the game and extract the complete [D18 0.1.2 ZIP](https://github.com/kkyleeb21/OptiScaler_DLSSNR/releases/tag/dlssnr-d18-v0.1.2).
