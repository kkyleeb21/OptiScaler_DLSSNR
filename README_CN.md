...
[English](README.md) · [下载 0.1.2](https://github.com/kkyleeb21/OptiScaler_DLSSNR/releases/tag/dlssnr-d18-v0.1.2) · [安装器说明](community/d18-installer/README_CN.md)
...
下表对应**通用 0.1.2 D18 界面**。旧版和游戏专用包的选项可能不同。
...
1. 完全退出游戏，解压完整 [D18 0.1.2 ZIP](https://github.com/kkyleeb21/OptiScaler_DLSSNR/releases/tag/dlssnr-d18-v0.1.2)。
