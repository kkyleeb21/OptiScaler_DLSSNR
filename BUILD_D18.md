...
The release packages intentionally reuse recorded binaries rather than rebuilding rendering code at publication. Compiler/SDK/build labels may change rebuilt hashes. Internal candidate labels remain in those binaries; VERSION, the source tag and SOURCE_PROVENANCE.json identify this distribution. Build identity does not establish gameplay correctness.
