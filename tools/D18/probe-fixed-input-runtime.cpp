...
int wmain(int argc,wchar_t** argv)try{
    ...
    require(mode==L"shared_chain_fixed"||mode==L"shared_same_input_fixed"||mode==L"independent_fixed","unsupported probe mode");
    ...
    for(unsigned frame=0;frame<64;++frame){
        ...
        for(unsigned pass=0;pass<2;++pass){
            ...
            const int result=eval(cmd.Get(),features[instance],params[instance],fixedInput.Get(),depth.Get(),shared&&pass>0?zeroMotion.Get():motion.Get(),answer,
