...
int wmain(int argc,wchar_t** argv)try{
    ...
    const UINT w=3840,h=2160,gw=1920,gh=1080;
    ...
    puts("PASS four distinct instances, mixed ratios, 1-4 counts, shared zero-motion repeats, history mode changes, GPU completion and finite final pixels; game quality not proven");return 0;
