...
int wmain(int argc,wchar_t** argv)try{
    ...
    const std::wstring resetPolicy=argv[9];require(resetPolicy==L"initial"||resetPolicy==L"every_call"||resetPolicy==L"first_pass"||resetPolicy==L"second_pass","reset policy");
    ...
    for(unsigned frame=0;frame<64;++frame){
        ...
        for(unsigned pass=0;pass<2;++pass){
            ...
            const bool reset=resetEveryCall||(resetPolicy==L"first_pass"&&pass==0)||(resetPolicy==L"second_pass"&&pass==1)||(frame==0&&(!shared||pass==0));
